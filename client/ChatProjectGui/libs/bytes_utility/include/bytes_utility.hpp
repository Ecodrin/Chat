...
namespace bytes_utility {
    ...
    void print_byte(std::ostream & stream, const std::byte & byte, bool hex=false); 
    void print_bytes_vector(std::ostream & stream, const std::vector<std::byte> & a, bool hex=false, const std::string & sep=" ", const std::string & end="\n");
